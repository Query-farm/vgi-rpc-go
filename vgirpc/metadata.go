...
const (
	...
	// MetaProtocol names the protocol a request addresses -- the routing key.
	//
	...
	// an incompatible major is a routing failure rather than a parse failure,
	// and v1 and v2 can be served side by side while clients migrate.
	MetaProtocol = "vgi_rpc.protocol"
